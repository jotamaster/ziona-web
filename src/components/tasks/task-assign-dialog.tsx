...
export function TaskAssignDialog({ homeId, task, members, open, onOpenChange }: TaskAssignDialogProps) {
  ...
  return (
    <>
      ...
      />
      <div
        className="neu-raised fixed left-1/2 top-1/2 z-[80] max-h-[min(80vh,28rem)] w-[min(100%,24rem)] -translate-x-1/2 -translate-y-1/2 overflow-y-auto rounded-[var(--neu-radius-lg)] p-6 shadow-[var(--neu-shadow-light),var(--neu-shadow-dark)]"
        role="dialog"
        aria-modal="true"
